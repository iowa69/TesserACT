...
//
// These lived in three: main.cpp for `tessera --version`, model_main.cpp for
// `tessera-model --version`, and a literal inside Assembler::run for the version written
...
// tessera-model that introduced --marker-density still called itself 1.1.0.
//
